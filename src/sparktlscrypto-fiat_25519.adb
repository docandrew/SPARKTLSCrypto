...
is
   ...
   function Mul (A, B : FE) return FE is
      ...
      x43                      : Unsigned_128;
      x44                      : Unsigned_64;
      x45, x46, x47            : Unsigned_128;
      x48                      : Unsigned_64;
      x49, x50                 : Unsigned_128;
      x51                      : Unsigned_64;
      x52                      : Unsigned_128;
   ...
   begin
      ...
      x45 := x43 * 19;
      pragma Assert (x45 <= Unsigned_128 (Unsigned_64'Last - Mask51));
      x46 := Unsigned_128 (x28) + x45;
      pragma Assert (x46 <= Unsigned_128 (Unsigned_64'Last));
      x47 := Shift_Right (x46, 51);
      x48 := Unsigned_64 (x46 and Unsigned_128 (Mask51));
      x49 := x47 + Unsigned_128 (x35);
      x50 := Shift_Right (x49, 51);
      x51 := Unsigned_64 (x49 and Unsigned_128 (Mask51));
      x52 := x50 + Unsigned_128 (x38);
      ...
      pragma Assert (x49 <= Unsigned_128 (Mask51) + 2**13 - 1);
      pragma Assert (x50 <= 1);
      ...
      pragma Assert (x52 <= Unsigned_128 (Tight51));
