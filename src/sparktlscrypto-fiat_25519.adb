...
package body SPARKTLSCrypto.Fiat_25519 with
   SPARK_Mode => On
is
   procedure Lemma_Reduced_Is_Mul_Safe (F : FE) is
   begin
      for I in 0 .. 4 loop
         pragma Assert (F (I) <= Tight51);
   ...
   function Mul (A, B : FE) return FE is
      ...
      x43                      : Unsigned_64;
      x44                      : Unsigned_64;
      x45, x46, x47            : Unsigned_64;
      x48                      : Unsigned_64;
      x49, x50                 : Unsigned_64;
      x51                      : Unsigned_64;
      x52                      : Unsigned_64;
      Product_Bound            : constant Unsigned_128 :=
        81_129_638_414_606_681_695_789_005_144_064;
      Product19_Bound          : constant Unsigned_128 :=
        1_541_463_129_877_526_952_219_991_097_737_216;
   begin
      ...
      pragma Assert (x26 <= 6_246_982_157_924_714_490_575_753_396_092_928);
      pragma Assert (Shift_Right (x26, 51) <= Unsigned_128 (Unsigned_64'Last));
      x27 := Unsigned_64 (Shift_Right (x26, 51));
      pragma Assert (x27 <= 2_774_217_370_460_225_536);
      ...
      pragma Assert (x6 <= Product19_Bound);
      pragma Assert (x8 <= Product19_Bound);
      pragma Assert (x16 <= Product_Bound);
      pragma Assert (x19 <= Product_Bound);
      pragma Assert (x20 <= Product_Bound);
      pragma Assert (x23 <= Product_Bound);
      pragma Assert (x24 <= Product_Bound);
      pragma Assert (x21 + (x17 + (x14 + (x12 + x11))) <=
                       2_028_240_960_365_167_042_394_725_128_601_600);
      pragma Assert (x23 + (x19 + (x16 + (x5 + x2))) <=
                       7_707_315_649_387_634_761_099_955_488_686_080);
      pragma Assert (x24 + (x20 + (x8 + (x6 + x3))) <=
                       7_707_315_649_387_634_761_099_955_488_686_080);
      pragma Assert (x29 <= 2_028_240_960_365_167_042_394_725_128_601_600);
      pragma Assert (x31 <= 7_707_315_649_387_634_761_099_955_488_686_080);
      pragma Assert (x32 <= 7_707_315_649_387_634_761_099_955_488_686_080);
      x33 := Unsigned_128 (x27) + x32;
      pragma Assert (x33 <= 7_707_315_649_387_637_535_317_325_948_911_616);
      pragma Assert (Shift_Right (x33, 51) <= Unsigned_128 (Unsigned_64'Last));
      x34 := Unsigned_64 (Shift_Right (x33, 51));
      pragma Assert (x34 <= 3_422_735_716_801_578_192);
      x35 := Unsigned_64 (x33 and 16#7_FFFF_FFFF_FFFF#);
      x36 := Unsigned_128 (x34) + x31;
      pragma Assert (x36 <= 7_707_315_649_387_638_183_835_672_290_264_272);
      pragma Assert (Shift_Right (x36, 51) <= Unsigned_128 (Unsigned_64'Last));
      ...
      pragma Assert (x42 <= 2_028_240_960_516_282_769_846_553_775_439_871);
      pragma Assert (Shift_Right (x42, 51) <= Unsigned_128 (Unsigned_64'Last));
      x43 := Unsigned_64 (Shift_Right (x42, 51));
      pragma Assert (x43 <= 900_719_925_541_208_063);
      x44 := Unsigned_64 (x42 and 16#7_FFFF_FFFF_FFFF#);
      pragma Assert (x43 <= 970_762_751_257_677_177);
      --  Carries fit in U64; the field products above still use U128.
      pragma Assert (x43 <= Unsigned_64'Last / 19);
      x45 := x43 * 19;
      pragma Assert (x45 <= Unsigned_64'Last - Mask51);
      pragma Assert (x28 <= Unsigned_64'Last - x45);
      x46 := x28 + x45;
      pragma Assert (x46 <= Unsigned_64'Last);
      x47 := Shift_Right (x46, 51);
      x48 := x46 and Mask51;
      pragma Assert (x47 <= Unsigned_64'Last - x35);
      x49 := x47 + x35;
      x50 := Shift_Right (x49, 51);
      x51 := x49 and Mask51;
      pragma Assert (x50 <= Unsigned_64'Last - x38);
      x52 := x50 + x38;
      --  Carry-chain bound: x47 = u64 >> 51 ≤ 2^13 - 1, x35 ≤ Mask51,
      --  so x49 ≤ Mask51 + 2^13 - 1 < 2^52, hence x50 = x49 >> 51 ≤ 1.
      --  x38 ≤ Mask51 (masked), so x52 = x50 + x38 ≤ 1 + Mask51 = 2^51.
      pragma Assert (x47 <= 2**13 - 1);
      pragma Assert (x35 <= Mask51);
      pragma Assert (x49 <= Mask51 + 2**13 - 1);
      pragma Assert (x50 <= 1);
      pragma Assert (x38 <= Mask51);
      pragma Assert (x48 <= Mask51);
      pragma Assert (x51 <= Mask51);
      pragma Assert (x41 <= Mask51);
      pragma Assert (x44 <= Mask51);
      pragma Assert (x48 <= Tight51);
      pragma Assert (x51 <= Tight51);
      pragma Assert (x52 <= Tight51);
      pragma Assert (Unsigned_64 (x52) <= Tight51);
      pragma Assert (x41 <= Tight51);
      pragma Assert (x44 <= Tight51);
      R := (x48, x51, Unsigned_64 (x52), x41, x44);
      pragma Assert (Is_Reduced (R));
      return R;
   end Mul;
   ...
   begin
      ...
      x49 := x47 and Mask51;
      x50 := x48 + x36;
      --  Carry-chain bound: x45 = u64 >> 51 ≤ 2^13 - 1, x33 ≤ Mask51,
      --  so x47 ≤ Mask51 + 2^13 - 1 < 2^52, hence x48 = x47 >> 51 ≤ 1.
      --  x36 ≤ Mask51 (masked), so x50 = x48 + x36 ≤ 1 + Mask51 = 2^51.
      pragma Assert (x45 <= 2**13 - 1);
      pragma Assert (x33 <= Mask51);
      pragma Assert (x47 <= Mask51 + 2**13 - 1);
      pragma Assert (x48 <= 1);
      pragma Assert (x36 <= Mask51);
      pragma Assert (x50 <= Tight51);
