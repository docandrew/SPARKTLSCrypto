...
procedure Ct_P256_ECDSA is
   --  Blinding bytes stay defined: they are public-quality randomness
   Blind : constant Byte_Seq (0 .. 39) := (others => 16#7E#);
...
begin
   ...
   SPARKTLSCrypto.P256.ECDSA.Sign (Hash, D, K, Blind, R, S, OK);
